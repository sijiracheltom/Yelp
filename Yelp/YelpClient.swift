...
class YelpClient: BDBOAuth1RequestOperationManager {
    ...
    func searchWithTerm(_ term: String, sort: YelpSortMode?, categories: [String]?, deals: Bool?, radius: YelpDistanceMode?, completion: @escaping ([Business]?, Error?) -> Void) -> AFHTTPRequestOperation {
        ...
        if radius != nil {
            parameters["radius_filter"] = distanceInMeters(distanceMode: radius!) as AnyObject?
        }
